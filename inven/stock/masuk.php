					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
                                ...
                                <div class="form-group">
									<label>No. SO</label>
									<input name="so" type="text" class="form-control">
								</div>
                                <div class="form-group">
									<label>No. PO</label>
								...
								<div class="form-group">
									...
									<?php
									$det=mysqli_query($conn,"select * from sstock_brg order by kode_brg ASC");
									while($d=mysqli_fetch_array($det)){
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['kode_brg'] ?> - <?php echo $d['nama'] ?></option>
										<?php
								}
								?>
									</select>
