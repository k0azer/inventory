						...
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								...
								<div class="form-group">
									...
									<?php
									$det=mysqli_query($conn,"select * from sstock_brg order by kode_brg ASC")or die(mysqli_error());
									while($d=mysqli_fetch_array($det)){
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['kode_brg'] ?> - <?php echo $d['nama'] ?> --- Stock : <?php echo $d['stock'] ?></option>
										<?php
								}
								?>		
									</select>
                                ...
                                <div class="form-group">
									<label>No. SO</label>
									<input name="so" type="text" class="form-control" placeholder="Nomer SO">
								</div>
                                <div class="form-group">
									<label>No. PO</label>
									<input name="po" type="text" class="form-control" placeholder="Nomer PO">
								</div>
								<div class="form-group">
									<label>Jumlah</label>
